        ...
        <h1 className={`${styles.sectionTitle} fadeIn`}> 
            ...
            <ul className={`eventBG ${styles.eventBg} fadeIn`}>
                ...
                <li><Event
                    ...
                    time = 'N/A'
                    links = {{
                    'itch.io': 'https://itch.io/jam/macgdc-game-jam-2026',
                    'Game Jam Results': 'https://www.youtube.com/watch?v=F1KvTGNxyKY'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    links = {{
                    'Discord': 'https://discord.com/invite/Gsvp8JKF66'
                    }}
                /></li>
                <li><Event
                    ...
                    time = '6:30PM - 9:00 PM'
                    links = {{
                    'YouTube': 'https://www.youtube.com/watch?v=h8l1EBVsnLA'
                    }}
                /></li>
                <li><Event
                    ...
                    time = '6:00 - 9:00 PM'
                    links = {{
                    'Livestream Recording': 'https://www.youtube.com/live/8yzkASNKOn0',
                    'www.insertdisc5.com': 'https://www.insertdisc5.com/'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    time = '6:00 - 8:00 PM'
                    links = {{
                    'YouTube Recording': 'https://www.youtube.com/watch?v=nfXEMOLIpbg'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    links = {{
                    'itch.io': 'https://macgdc.itch.io/microgame-jam-2025'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    time = '7:00 - 9:00 PM'
                    links = {{
                    'itch.io': 'https://macgdc.itch.io/level-design-challenge-2025'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    time = '7:00 - 9:00 PM (Awards Ceremony)'
                    links = {{
                    'itch.io': 'https://itch.io/jam/macgdc-game-jam-2025'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    time = '7:00 - 9:00 PM (Awards Ceremony)'
                    links = {{
                    'itch.io': 'https://macgdc.itch.io/microgame-jam-2024'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    links = {{
                    'itch.io': 'https://itch.io/jam/macgdc-game-jam-2023'
                    }}
                /></li>
                ...
                <li><Event
                    ...
                    links = {{
                    'itch.io': 'https://macgdc.itch.io/microgame-jam-2023'
                    }}
                /></li>
            </ul>
        </>
