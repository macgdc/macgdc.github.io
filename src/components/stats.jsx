    ...
    return(
        <div className={`${styles.stats} fadeIn`}>
            <div className={styles.statItem}>
                <img src="images/member.png" alt="" className={styles.statIcon} />
                <div className={styles.bigstat}><CountUp end={500}/>+</div>
                <div className={styles.statLabel}>MEMBERS</div>
            </div>
            <div className={styles.statItem}>
                <img src="images/gamepad.png" alt="" className={styles.statIcon} />
                <div className={styles.bigstat}><CountUp end={70}/>+</div>
                <div className={styles.statLabel}>GAMES MADE</div>
            </div>
            <div className={styles.statItem}>
                <img src="images/laptop.svg" alt="" className={styles.statIcon} />
            ...
            <div className={styles.statItem}>
                <img src="images/presentation.png" alt="" className={styles.statIcon} />
